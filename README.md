...
Real-time **Valorant** AI coaching overlay. Occlara sits on top of the game in
borderless-windowed mode, periodically captures the screen, sends it to the
Occlara server for AI analysis, and shows concise coaching tips on a
...
After that, Occlara launches straight to the overlay + control panel.
...
- **License-based**, no API keys. The client only talks to the Occlara backend.
