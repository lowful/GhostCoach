...
Last updated: July 19, 2026 (v2.1.17). Everything below is accurate to the shipped product.
...
- Onboarding, license activation, tray, hotkeys, minimized floating ghost dock.
...
8. The similarity gate was too strict at match length; important advice must be repeatable. Now repeats are allowed after 60 seconds in fresh wording with escalation ("still", "again", "third time now").
...
- Versioning has been patch-only (2.1.0 through 2.1.17 in rapid iteration); the plan is to adopt semver properly going forward: next feature batch becomes 2.2.0, fixes become 2.2.x.
